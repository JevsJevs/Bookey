                ...
                <div class=\"col s6 m6 l6 offset-s3 offset-l3 offset-m3\">
                      <div class=\"card blue-grey darken-1\">
                            <div class=\"card-content white-text center-align\">
                                  <span class=\"card-title\" style='color: red'>Erro ao cadastrar! Todos os parametros sao obrigatorios</span>
                                  <hr><br/>
                                    <input type=\"button\" onclick=\"location.href='../../../html/CadQuarto.html'\" value=\"Tentar novamente\">
                            </div>
                      </div>
                </div>
             </div>
